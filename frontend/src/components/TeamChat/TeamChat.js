...
// import { MessageCircle, X, Send, Hash, ChevronDown, Plus, Trash2, RefreshCw } from 'lucide-react';
...
//             <div style={{ flex: 1 }}>
//               {/* Project Dropdown */}
//               <div style={{ position: 'relative', marginBottom: '8px' }} ref={dropdownRef}>
//                 <button
...
//                         padding: '8px',
//                         border: 'none',
//                         background: currentChannel === channel.id ? 'white' : 'transparent',
//                         borderRadius: '6px',
//                         cursor: 'pointer',
//                         textAlign: 'left',
//                         display: 'flex',
//                         alignItems: 'center',
//                         gap: '6px',
//                         boxShadow: currentChannel === channel.id ? '0 1px 2px rgba(0,0,0,0.05)' : 'none'
//                       }}
//                     >
